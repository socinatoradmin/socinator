...
namespace FaceDominatorCore.FDModel.InviterModel
{

    public interface IWatchPartyInviterModel
    {
    ...
    public class WatchPartyInviterModel : ModuleSetting, IWatchPartyInviterModel
    {
        ...
        [ProtoMember(2)]
        public override InviterDetails InviterDetailsModel { get; set; } = new InviterDetails();

        [ProtoMember(3)]
        public override InviterOptions InviterOptionsModel { get; set; } = new InviterOptions();

        [ProtoMember(4)]
        public override SelectAccountDetailsModel SelectAccountDetailsModel { get; set; } = new SelectAccountDetailsModel();

        private bool _isSelectDetails;
        ...
        public bool IsSelctDetails
        {
            get
            {
                return _isSelectDetails;
            }
            set
            {
                SetProperty(ref _isSelectDetails, value);
            }
        }

...
namespace FaceDominatorCore.FDModel.FriendsModel
{
    ...
    public interface IUnfollowFriendModel
    {
    ...
    public class UnfollowFriendModel : ModuleSetting, IUnfollowFriendModel
    {
        ...
        private UnfriendOption _unfollowOptionModel = new UnfriendOption();
        [ProtoMember(3)]
        public UnfriendOption UnfollowOptionModel
        {
            get { return _unfollowOptionModel; }
            set
            {
                SetProperty(ref _unfollowOptionModel, value);
            }
        }

...
{
    public interface IIncommingFriendRequestModel
    {
        //        bool IsAcceptFilterVisible { get; set; }
        //
        //        bool IsCancelFilterVisible { get; set; }
    }

    public class IncommingFriendRequestModel : ModuleSetting, IIncommingFriendRequestModel
    {
        [ProtoMember(1)]
        public override JobConfiguration JobConfiguration { get; set; }

        [ProtoMember(2)]
        public override ManageFriends ManageFriendsModel { get; set; } = new ManageFriends();
        ...
        [ProtoMember(8)]
        public override FdGenderAndLocationFilterModel GenderAndLocationCancelFilter { get; set; } = new FdGenderAndLocationFilterModel();



        private bool _isAcceptFilterVisible;
        [ProtoMember(9)]
        public bool IsAcceptFilterVisible
        {
            get
            {
                return _isAcceptFilterVisible;
            }
            set
            {
                SetProperty(ref _isAcceptFilterVisible, value);
            }
        }


        private bool _isCancelFilterVisible;
        [ProtoMember(10)]
        public bool IsCancelFilterVisible
        {
            get
            {
                return _isCancelFilterVisible;
            }
            set
            {
                SetProperty(ref _isCancelFilterVisible, value);
            }
        }
    }
}

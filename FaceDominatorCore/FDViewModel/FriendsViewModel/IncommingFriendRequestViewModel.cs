...
{
    public class IncommingFriendRequestViewModel : BindableBase
    {
        public IncommingFriendRequestViewModel()
        {

            IncommingFriendRequestModel.JobConfiguration = new JobConfiguration
            {
        ...
        private void CustomFilter(object sender)
        {
            try
            {
                var moduleSettingsUserControl = sender as DominatorUIUtility.CustomControl.ModuleSettingsUserControl<IncommingFriendRequestViewModel, IncommingFriendRequestModel>;
        ...
        public IncommingFriendRequestModel Model => IncommingFriendRequestModel;

        private IncommingFriendRequestModel _incommingFriendRequestModel = new IncommingFriendRequestModel();

        public IncommingFriendRequestModel IncommingFriendRequestModel
        {
            get
            {
                return _incommingFriendRequestModel;
            }
            set
            {
                if (_incommingFriendRequestModel == null & _incommingFriendRequestModel == value)
                    return;
                SetProperty(ref _incommingFriendRequestModel, value);
            }
        }
    }
}

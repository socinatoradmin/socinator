...
namespace FaceDominatorCore.FDViewModel.Inviter
{
    public class GroupInviterViewModel : BindableBase
    {
        ...
        private void CustomFilter(object sender)
        {
            try
            {
                var moduleSettingsUserControl = sender as DominatorUIUtility.CustomControl.ModuleSettingsUserControl<GroupInviterViewModel, GroupInviterModel>;

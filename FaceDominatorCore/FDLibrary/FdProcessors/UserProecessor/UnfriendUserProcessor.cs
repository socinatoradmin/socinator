...
{
    public class UnfriendUserProcessor : BaseFbNonQueryUserProcessor
    {
        public UnfriendUserProcessor(IFdJobProcess jobProcess, IDbAccountServiceScoped dbAccountService,
            ...
            try
            {
                ...
                while (!jobProcessResult.IsProcessCompleted && !jobProcessResult.HasNoResult)
                {
                    ...
                    if (JobProcess.ModuleSetting.UnfriendOptionModel.IsMutualFriends)
                        queryList.Add("UnfriendMutualFriend");

                    FilterAndStartFinalProcessForUnfriendWithQueryList(ref jobProcessResult, queryList, "Unfriend");
                }
            }
        ...
        private void FilterAndStartFinalProcessForUnfriendWithQueryList(ref JobProcessResult jobProcessResult, List<string> queryList, string queryValue)
        {

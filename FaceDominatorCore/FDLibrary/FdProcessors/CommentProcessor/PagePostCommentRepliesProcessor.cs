...
{
    public class PagePostCommentRepliesProcessor : BaseFbCommentLikerProcessor
    {
        public PagePostCommentRepliesProcessor(IFdJobProcess jobProcess, IDbAccountServiceScoped dbAccountService, IDbCampaignServiceScoped campaignService, IFdRequestLibrary objFdRequestLibrary, IFdBrowserManager browserManager, IProcessScopeModel processScopeModel)
                ...
                while (!jobProcessResult.IsProcessCompleted && !jobProcessResult.HasNoResult)
                {
                    ...
                    try
                    {
                        ...
                        if (responseHandler != null && responseHandler.Status)
                        {
                            ...
                            DominatorHouseCore.LogHelper.GlobusLogHelper.log.Info(Log.FoundXResults, AccountModel.AccountBaseModel.AccountNetwork, AccountModel.AccountBaseModel.UserName, lstPostId.Count, queryInfo.QueryType, queryInfo.QueryValue, _ActivityType);

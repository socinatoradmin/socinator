...
{
    [ProtoContract]
    public class LikeModel : ModuleSetting, IGeneralSettings
    {
        ...
        private RangeUtilities _DelayBetweenLikeCommentRange = new RangeUtilities {StartValue = 20, EndValue = 50};

        [ProtoMember(25)]
        public RangeUtilities DelayBetweenLikeCommentRange
        {
            get => _DelayBetweenLikeCommentRange;
            set
            {
                if (_DelayBetweenLikeCommentRange == value)
                    return;
                SetProperty(ref _DelayBetweenLikeCommentRange, value);
            }
        }
        ...
        public bool IsChkActionTweetPerUser
        {
            ...
            set
            {
                if (value == _IsChkActionTweetPerUser)
                    return;
        ...
        private RangeUtilities _NoOfActionTweetPerUser = new RangeUtilities { StartValue = 2, EndValue = 2 };
        ...
        public RangeUtilities NoOfActionTweetPerUser
        {
            ...
            set
            {
                if (value == _NoOfActionTweetPerUser)
                    return;

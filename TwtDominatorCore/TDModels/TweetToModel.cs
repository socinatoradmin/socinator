...
{
    [ProtoContract]
    public class TweetToModel : ModuleSetting, IGeneralSettings
    {
        private RangeUtilities _increaseEachDayFollow = new RangeUtilities();
        ...
        private Visibility _MediaListVisibility = Visibility.Collapsed;
        private string _TweetToTweetText = string.Empty;
        private string _VideoFilePath;
        private Visibility _VideoFilePathVisibility = Visibility.Collapsed;
        ...
        #region TweetTo Manager

        [ProtoMember(29)]
        public string TweetToText
        {
            get => _TweetToTweetText;
            set => SetProperty(ref _TweetToTweetText, value);
        }
        ...
        [ProtoMember(31)]
        public Visibility MediaListVisibility
        {
            get => _MediaListVisibility;
            set => SetProperty(ref _MediaListVisibility, value);
        }
        ...
        [ProtoMember(33)]
        public Visibility VideoFilePathVisibility
        {
            get => _VideoFilePathVisibility;
            set => SetProperty(ref _VideoFilePathVisibility, value);
        }

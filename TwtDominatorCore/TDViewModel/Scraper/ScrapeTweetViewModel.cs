...
{
    public class ScrapeTweetViewModel : BindableBase
    {
        private ScrapeTweetModel _scrapeTweetModel = new ScrapeTweetModel();

        public ScrapeTweetViewModel()
        {
        ...
        public ScrapeTweetModel ScrapeTweetModel
        {
            ...
            set => SetProperty(ref _scrapeTweetModel, value);
        }
        ...
        private void CustomFilter(object sender)
        {
            try
            {
                var ModuleSettingsUserControl =
                    sender as ModuleSettingsUserControl<ScrapeTweetViewModel, ScrapeTweetModel>;

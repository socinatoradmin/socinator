...
{
    internal class FollowersOfFollowersTweet : BaseTwitterTweetsProcessor, IQueryProcessor
    {
        public FollowersOfFollowersTweet(ITdJobProcess jobProcess, IBlackWhiteListHandler blackWhiteListHandler,

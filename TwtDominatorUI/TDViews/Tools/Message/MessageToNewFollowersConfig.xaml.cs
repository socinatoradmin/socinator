...
{
    public class MessageToNewFollowersConfigBase : ModuleSettingsUserControl<MessageViewModel, MessageModel>
    {
    ...
    /// <summary>
    ///     Interaction logic for MessageToNewFollowersConfig.xaml
    /// </summary>
    public partial class MessageToNewFollowersConfig : MessageToNewFollowersConfigBase
    {
        public MessageToNewFollowersConfig()
        {
            InitializeComponent();

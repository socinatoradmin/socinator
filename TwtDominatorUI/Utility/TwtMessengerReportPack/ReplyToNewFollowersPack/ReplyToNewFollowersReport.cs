...
namespace TwtDominatorUI.Utility.TwtEngageReportPack.ReplyToNewFollowersPack
{
    public class ReplyToNewFollowersReport : ITDReportFactory
    {
        ...
        public IList GetsAccountReport(IDbAccountService dataBase)
        {
            ...
            dataBase.GetInteractedUsers(ActivityType.SendMessageToFollower)?.ForEach(
                report =>
                {
            ...
            #region Send Message to new followers

...
{
    internal class AutoReplyReport : ITDReportFactory
    {
        ...
        public IList GetsAccountReport(IDbAccountService dataBase)
        {
            ...
            dataBase.GetInteractedUsers(ActivityType.AutoReplyToNewMessage)?.ForEach(
                report =>
                {
            ...
            // this.CsvHeader = "Sl no,User Name,UserId,Message Text,Sending Date";
        ...
        public void ExportReports(string fileName, ReportType reportType)
        {
            ...
            {
                Header = "Sl No,Account,User ID,User Name,Message Text,Media Path,Message Date";
            ...
            {
                Header = "Sl No,User ID,User Name,Message Text,Media Path,Message Date";

...
{
    public class TwtUnLikerReport : ITDReportFactory
    {
        ...
        {
            return JsonConvert.DeserializeObject<UnLikeModel>(activitySettings).SavedQueries;
        }
        ...
        public ObservableCollection<object> GetCampaignsReport(ReportModel ObjReports, CampaignDetails campaignDetails)
        {
            ...
            ObjReports.GridViewColumn =
                new ObservableCollection<GridViewColumnDescriptor>
                {
                    ...
                    new GridViewColumnDescriptor {ColumnHeaderText = "UnLiked Tweet Id", ColumnBindingText = "TweetId"},
                    ...
                    new GridViewColumnDescriptor
                        {ColumnHeaderText = "UnLiked Date", ColumnBindingText = "InteractionDate"}
                };
        ...
        public IList GetsAccountReport(IDbAccountService dataBase)
        {
            ...
            dataBase.GetInteractedPosts(ActivityType.Unlike)?.ForEach(
                report =>
                {
        ...
        public void ExportReports(string fileName, ReportType reportType)
        {
            ...
            {
                Header =
                    "Sl No,Account,Query Type,Query Value,UnLiked Tweet Id,Tweeted Text,Tweet Owner,Retweet,Following,Following Back,UnLiked Date";
            ...
            {
                Header =
                    "Sl No,Query Type,Query Value,Tweet Id,Tweeted Text,Tweet Owner,Tweeted Date, Media Path, Retweet,Follow Status,Follow Back Status,Process Type,UnLiked Date";

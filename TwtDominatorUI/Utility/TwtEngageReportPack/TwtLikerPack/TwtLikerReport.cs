...
{
    internal class TwtLikerReport : ITDReportFactory
    {
        ...
        public ObservableCollection<object> GetCampaignsReport(ReportModel ObjReports, CampaignDetails campaignDetails)
        {
            ...
            try
            {
                // List<InteractedPosts> listPosts = dboperation.Get<InteractedPosts>();
                dboperation.GetAllInteractedPosts().Where(x => x.QueryType != null).ForEach(
                    report =>
                    {
            ...
            ObjReports.GridViewColumn =
                new ObservableCollection<GridViewColumnDescriptor>
                {
                    ...
                    new GridViewColumnDescriptor {ColumnHeaderText = "Liked Tweet Id", ColumnBindingText = "TweetId"},
        ...
        public IList GetsAccountReport(IDbAccountService dataBase)
        {
            ...
            dataBase.GetInteractedPosts(ActivityType.Like).Where(x => x.QueryType != null)?.ForEach(
                report =>
                {
            ...
            //  CsvHeader = "Sl No,Query Type,Query Value,Tweet Id,Tweeted Text,Tweet Owner,Tweeted Date, Media Path, Retweet,Follow Status,Follow Back Status,Process Type,Liked Date";
            //  break;
        ...
        public void ExportReports(string fileName, ReportType reportType)
        {
            ...
            {
                Header =
                    "Sl No,Account,Query Type,Query Value,Liked Tweet Id,Tweeted Text,Tweet Owner,Retweet,Following,Following Back,Liked Date";
            ...
            {
                Header =
                    "Sl No,Query Type,Query Value,Tweet Id,Tweeted Text,Tweet Owner,Tweeted Date, Media Path, Retweet,Follow Status,Follow Back Status,Process Type,Liked Date";
                ...
                AccountsInteractedUsers.ToList().ForEach(x =>
                {
                    try
                    {
                        csvData.Add(x.SlNo + "," + x.QueryType + "," + x.QueryValue + ",'" + x.TweetId + "',\"" +
                                    ...
                                    x.TweetedDate + ",\"" + x.MediaPath.Replace("\"", "\"\"") + "\"," + x.Retweet +
                                    "," + x.FollowStatus + "," + x.FollowBackStatus + "," + x.ProcessType + "," +

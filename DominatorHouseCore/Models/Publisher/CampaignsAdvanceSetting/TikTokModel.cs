...
{
    [ProtoContract]
    public class TikTokModel : BindableBase
    {
        private bool _isNavigateFromWall;

        [ProtoMember(1)]
        public bool IsNavigateFromWall
        {
            get => _isNavigateFromWall;
            set
            {
                if (_isNavigateFromWall == value)
                    return;
                SetProperty(ref _isNavigateFromWall, value);
            }
        }

        private bool _isUseSimplifiedMethod;

        [ProtoMember(2)]
        public bool IsUseSimplifiedMethod
        {
            get => _isUseSimplifiedMethod;
            set
            {
                if (_isUseSimplifiedMethod == value)
                    return;
                SetProperty(ref _isUseSimplifiedMethod, value);
            }
        }
        ...
        private bool _isHidePost;

        [ProtoMember(6)]
        public bool IsHidePost
        {
            get => _isHidePost;
            set
            {
                if (_isHidePost == value)
                    return;
                SetProperty(ref _isHidePost, value);
            }
        }
        ...
        public TikTokModel Clone()
        {
            return (TikTokModel)MemberwiseClone();
        }
    }
}
...
{
    [ProtoContract]
    public class AcceptConnectionRequestModel : ModuleSetting
    {
        private bool _IsChkAllInvitations = true;
        ...
        {
            get => _IsChkAllInvitations;
            set => SetProperty(ref _IsChkAllInvitations, value);
        }

...
{
    public class InviteMemberToFollowPageModel : ModuleSetting, IGeneralSettings
    {
        private bool _IsCheckedLangKeyCustomAdminPageList;

        private bool _IsCheckedPageSource;
        ...
        [ProtoMember(8)]
        public bool IsCheckedPageSource
        {
            get => _IsCheckedPageSource;
            set => SetProperty(ref _IsCheckedPageSource, value);
        }
        ...
        [ProtoMember(10)]
        public bool IsCheckedLangKeyCustomAdminPageList
        {
            get => _IsCheckedLangKeyCustomAdminPageList;
            set
            {
                if (value == _IsCheckedLangKeyCustomAdminPageList) return;
                SetProperty(ref _IsCheckedLangKeyCustomAdminPageList, value);
            }
        }

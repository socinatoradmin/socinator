...
namespace LinkedDominatorCore.LDModel
{
    ...
    public class UserScraperModel : ModuleSetting
    {
        ...
        private bool _IsEmailExistCheckbox;
        private bool _IsPhoneNumberExistCheckbox;
        ...
        public bool IsCheckedVisiting
        {
            ...
            set
            {
                if (_IsCheckedVisiting == value)
                    return;
                SetProperty(ref _IsCheckedVisiting, value);
            }
        }
        ...
        [ProtoMember(10)]
        public bool IsEmailExistCheckbox
        {
            get => _IsEmailExistCheckbox;
            set
            {
                if (value == _IsEmailExistCheckbox) return;
                SetProperty(ref _IsEmailExistCheckbox, value);
            }
        }

        [ProtoMember(11)]
        public bool IsPhoneNumberExistCheckbox
        {
            get => _IsPhoneNumberExistCheckbox;
            set
            {
                if (value == _IsPhoneNumberExistCheckbox) return;
                SetProperty(ref _IsPhoneNumberExistCheckbox, value);
            }
        }
    }
}
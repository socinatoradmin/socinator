...
{
    public interface IDownvoteCommentViewModel
    {
    }

    public class DownvoteCommentViewModel : StartupBaseViewModel, IDownvoteCommentViewModel
    {
        public DownvoteCommentViewModel(IRegionManager region) : base(region)
        {
            ViewModelToSave.Add(new ActivityConfig {Model = this, ActivityType = ActivityType.DownvoteComment});

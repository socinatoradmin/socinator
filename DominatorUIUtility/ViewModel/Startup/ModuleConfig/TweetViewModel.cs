...
{
    public interface ITweetViewModel
    {
    }

    public class TweetViewModel : StartupBaseViewModel, ITweetViewModel
    {
        public TweetViewModel(IRegionManager region) : base(region)
        {
            ViewModelToSave.Add(new ActivityConfig {Model = this, ActivityType = ActivityType.Tweet});

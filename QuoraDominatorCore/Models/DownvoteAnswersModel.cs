...
{
    public interface IDownvoteAnswersModel
    {
        #region IDownvoteAnswersModel
    ...
    [ProtoContract]
    public class DownvoteAnswersModel : ModuleSetting, IDownvoteAnswersModel, IGeneralSettings
    {
        ...
        [ProtoMember(14)]public override TopicFilterModel TopicFilter { get; set; }= new TopicFilterModel();
        ...
        private RangeUtilities _followMaxBetween = new RangeUtilities(100, 200);
        ...
        public bool IsChkIncreaseEachDayFollow
        {
            ...
            set
            {
                if (value == _isChkIncreaseEachDayFollow) return;
        ...
        [ProtoMember(12)]
        public bool IsChkDownvoteAnswerPrivateBlacklist
        {
        ...
        [ProtoMember(13)]
        public bool IsChkDownvoteAnswerGroupBlacklist
        {
        ...
        public bool IsChkDownvoteAnswerSkipPrivateBlacklist
        {
        ...
        public bool IsChkDownvoteAnswerSkipGroupBlacklist
        {

...
{
    [TestClass]
    public class SuggestedFriendsProcessorsTest:BaseFacebookProcessorTest
    {
        private SuggestedFriendsProcessor _sut;
        ...
        [TestMethod]
        public void SuggestedFriendsProcessor_Should_Execute_Successfully()
        {
      ...
      ("FaceDominatorCore.UnitTests.TestData.FdLibraryData.GetFriendSuggestedByFacebookRespose.html", Assembly.GetExecutingAssembly());
            ...
            var responseHandler =
                new FriendSuggestedByAFriendResponseHandler(responseParameter, Arg.Any<List<FacebookUser>>());

            var queryInfo = new QueryInfo { QueryValue = "" };
            _fdJobProcess.FinalProcess(new ScrapeResultNew());

            FdRequestLibrary.GetFriendSuggestedByFacebook(Arg.Any<DominatorAccountModel>(), null)
                .Returns(responseHandler);

            _sut = new SuggestedFriendsProcessor
            ...
            FdRequestLibrary.Received(1)
                .GetFriendSuggestedByFacebook(Arg.Any<DominatorAccountModel>(), null);
        ...
        public void SuggestedFriendsProcessor_Should_Failed_To_Execute()
        {
            ...
            FdRequestLibrary.GetFriendSuggestedByFacebook(Arg.Any<DominatorAccountModel>(), null)
                .Returns((FriendSuggestedByAFriendResponseHandler)null);

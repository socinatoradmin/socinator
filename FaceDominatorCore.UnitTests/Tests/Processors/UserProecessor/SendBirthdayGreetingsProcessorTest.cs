...
{
    [TestClass]
    public class SendBirthdayGreetingsProcessorTest : BaseFacebookProcessorTest
    {
        private SendBirthdayGreetingsProcessor _sut;
        ...
        [TestMethod]
        public void SendBirthdayGreetingsProcessor_Should_Execute_Successfully()
        {
      ...
      ("FaceDominatorCore.UnitTests.TestData.FdLibraryData.GetUsersBirtdayResponse.html", Assembly.GetExecutingAssembly());
            ...
            var responseHandler = new FdUserBirthdayResponseHandlerMobile(responseParameter)
            {
                Status = true
            };
            ...
            FdRequestLibrary.GetUsersBirtdayResponse(Arg.Any<DominatorAccountModel>(), null)
                .Returns(responseHandler);

            _sut = new SendBirthdayGreetingsProcessor
            ...
            FdRequestLibrary.Received(1)
                .GetUsersBirtdayResponse(Arg.Any<DominatorAccountModel>(), null);
        ...
        [TestMethod]
        public void SendBirthdayGreetingsProcessor_Should_Failed_To_Execute()
        {
            ...
            FdRequestLibrary.GetUsersBirtdayResponse(Arg.Any<DominatorAccountModel>(), null)
                .Returns((FdUserBirthdayResponseHandlerMobile)null);

            // act
            _sut.Start(queryInfo);

            // assert
            FdRequestLibrary.Received(1).GetUsersBirtdayResponse(Arg.Any<DominatorAccountModel>(), null);
        }
    }
}

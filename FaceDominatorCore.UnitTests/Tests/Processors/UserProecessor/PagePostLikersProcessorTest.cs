...
{
    [TestClass]
    public class PagePostLikersProcessorTest : BaseFacebookProcessorTest
    {
        private PagePostLikersProcessor _sut;
        ...
        [TestMethod]
        public void PagePostLikersProcessors_Should_Execute_Successfully()
        {
      ...
      ("FaceDominatorCore.UnitTests.TestData.FdLibraryData.GetPostListFromFanpagesResponse.html", Assembly.GetExecutingAssembly());
            ...
            var listPostReaction = new PostReactionListResponseHandler(responseParameter).ListPostReaction;
            ...
            var responseHandler = new ScrapPostListFromFanpageResponseHandler
                (responseParameter, listPostReaction)
            {
                Status = true
            };
            ...
            FdRequestLibrary.GetPostListFromFanpages(Arg.Any<DominatorAccountModel>(), Arg.Any<string>(), null)
                .Returns(responseHandler);

            _sut = new PagePostLikersProcessor
            ...
            FdRequestLibrary.Received(1)
                .GetPostListFromFanpages(Arg.Any<DominatorAccountModel>(), Arg.Any<string>(), null);
        ...
        public void MessageToNewFriendsProcessor_Should_Failed_To_Execute()
        {
            ...
            // assert
            FdRequestLibrary.Received(1).GetPostListFromFanpages(Arg.Any<DominatorAccountModel>(), Arg.Any<string>(), null);
        }

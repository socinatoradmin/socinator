...
{
    [TestClass]
    public class GraphSearchUserPrcessorTest : BaseFacebookProcessorTest
    {
        private GraphSearchUserPrcessor _sut;
        ...
        [TestMethod]
        public void GraphSearchUserPrcessor_Should_Execute_Successfully()
        {
      ...
      ("FaceDominatorCore.UnitTests.TestData.FdLibraryData.searchPeopleGraphResponse.html", Assembly.GetExecutingAssembly());
            ...
            FdRequestLibrary.SearchPeopleFromGraphSearch
                (Arg.Any<DominatorAccountModel>(), Arg.Any<string>(), null, Arg.Any<CancellationToken>()).Returns(responseHandler);

            _sut = new GraphSearchUserPrcessor
            ...
            // assert
            FdRequestLibrary.Received(1).SearchPeopleFromGraphSearch
                (Arg.Any<DominatorAccountModel>(), Arg.Any<string>(), null, Arg.Any<CancellationToken>());
        ...
        [TestMethod]
        public void GraphSearchUserPrcessor_Should_Failed_To_Execute()
        {
            ...
            FdRequestLibrary.SearchPeopleFromGraphSearch
                (Arg.Any<DominatorAccountModel>(), Arg.Any<string>(), null, Arg.Any<CancellationToken>()).Returns((FdSearchPeopleResponseHandler)null);
            // act
            _sut.Start(queryInfo);

...
{
    [TestClass]
    public class KeywordFanpageProcessorTest : BaseFacebookProcessorTest
    {
        private KeywordFanpageProcessor _sut;
        ...
        [TestMethod]
        public void KeywordFanpageProcessor_Should_Execute_Successfully()
        {
            // arrange  
            var queryInfo = new QueryInfo { QueryValue = "" };
            _fdJobProcess = new CommentLikerProcesss(ProcessScopeModel, DbAccountServiceScoped, FdQueryScraperFactory,
                FdHttpHelper, FdLoginProcess, FdRequestLibrary, DbCampaignServiceScoped);
            ...
            FdRequestLibrary.GetFanpageDetailsFromKeyword
                    (Arg.Any<DominatorAccountModel>(), Arg.Any<string>(), Arg.Any<bool>(), Arg.Any<bool>(), Arg.Any<FanpageCategory>(), null)
            ...
            var pageResponseHandler = new FanpageScraperResponseHandler(responseParameters, new FanpageDetails());

            FdRequestLibrary.GetFanpageDetails(_fdJobProcess.AccountModel, new FanpageDetails(),true)
                .Returns(pageResponseHandler);

            _sut = new KeywordFanpageProcessor
            ...
            FdRequestLibrary.Received(1).GetFanpageDetailsFromKeyword
        ...
        [TestMethod]
        public void KeywordFanpageProcessor_Should_Fail_Execute()
        {
            var queryInfo = new QueryInfo { QueryValue = "" };

...
{
    [TestClass]
    public class GraphSearchGroupProcessorsTest : BaseFacebookProcessorTest
    {
        private GraphSearchGroupProcessors _sut;
        ...
        public void GraphSearchGroupProcessors_Should_Execute_Successfully()
        {
            ...
            _sut = new GraphSearchGroupProcessors
        ...
        [TestMethod]
        public void GraphSearchGroupProcessors_Should_Failed_To_Execute()
        {

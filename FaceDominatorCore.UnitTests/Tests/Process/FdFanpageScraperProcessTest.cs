...
{
    [TestClass]
    public class FdFanpageScraperProcessTest : BaseFacebookProcessTest
    {
        private FdFanpageScraperProcess _sut;
        ...
        public override void SetUp()
        {
            ...
            _sut = new FdFanpageScraperProcess(ProcessScopeModel, DbAccountServiceScoped, FdQueryScraperFactory, FdHttpHelper, FdLoginProcess, DbCampaignServiceScoped);

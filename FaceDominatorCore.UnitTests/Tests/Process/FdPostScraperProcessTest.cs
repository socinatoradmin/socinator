...
{
    [TestClass]
    public class FdPostScraperProcessTest : BaseFacebookProcessTest
    {
        private FdPostScraperProcess _sut;
        ...
        public override void SetUp()
        {
            ...
            _sut = new FdPostScraperProcess(ProcessScopeModel, DbAccountServiceScoped, FdQueryScraperFactory, FdHttpHelper, FdLoginProcess,DbCampaignServiceScoped);

        }

        [TestMethod]
        public void Should_FdPostScraper_And_Save_Result_In_Database()
        {

            _scrapeResultNew = new ScrapeResultNew
            {
                ResultPost = new FacebookPostDetails { Id = "65447687" },

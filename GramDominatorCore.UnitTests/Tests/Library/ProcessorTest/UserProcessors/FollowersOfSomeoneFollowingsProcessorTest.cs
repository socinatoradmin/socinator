...
{
    [TestClass]
    public class FollowersOfSomeoneFollowingsProcessorTest:BaseGdProcessTest
    {
        ...
        [TestMethod]
        [Timeout(15000)]
        public void should_search_For_FollowersOfFollowings()
        {
            //arrange
            ...
            FollowerAndFollowingIgResponseHandler FollowingResponse = new FollowerAndFollowingIgResponseHandler(new ResponseParameter() { Response = Followingpageresponse });
            ...
            FollowersOfFollowingsProcessor followersOfFollowersProcessor =
                new FollowersOfFollowingsProcessor(_gdJobProcess, AccountServiceScoped, CampaignService,
                    ProcessScopeModel, DelayService);
            followersOfFollowersProcessor.Start(queryInfo);
            //assert
            _gdJobProcess.Received(400).FinalProcess(Arg.Any<ScrapeResultNew>());
            ...
            _gdJobProcess.instaFunct.Received(200).GetUserFollowers(Arg.Any<DominatorAccountModel>(), Arg.Any<string>(), Arg.Any<CancellationToken>(), Arg.Any<string>(), Arg.Any<string>());
        }      
    }
}

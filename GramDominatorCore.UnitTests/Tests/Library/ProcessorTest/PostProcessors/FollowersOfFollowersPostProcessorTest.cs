...
{
    [TestClass]
    public class FollowersOfFollowersPostProcessorTest : BaseGdProcessTest
    {
        ...
        [TestMethod]
        [Timeout(10000)]
        public void should_search_For_FollowersOfFollowersPost_Will_return_true()
        {
            //arrange
            ...
            _gdJobProcess.instaFunct.Received(2).GetUserFollowers(Arg.Any<DominatorAccountModel>(), Arg.Any<string>(), Arg.Any<CancellationToken>(), Arg.Any<string>(), Arg.Any<string>());
        }

        [TestMethod]
        [Timeout(15000)]
        public void should_search_For_FollowersOfFollowersPost_Will_return_User_Not_Found()
        {
            //arrange
            var queryInfo = new QueryInfo
            {
            ...
            //act
            _gdJobProcess.instaFunct.SearchUsername(Arg.Any<DominatorAccountModel>(), Arg.Any<string>(),Arg.Any<CancellationToken>()).Returns(username);
            FollowersOfFollowersPostProcessor followersOfFollowersProcessor = new FollowersOfFollowersPostProcessor(_gdJobProcess, AccountServiceScoped, CampaignService, ProcessScopeModel, DelayService);
            followersOfFollowersProcessor.Start(queryInfo);
            //assert

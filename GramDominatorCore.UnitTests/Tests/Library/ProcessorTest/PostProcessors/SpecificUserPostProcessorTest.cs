...
{
    [TestClass]
    public class SpecificUserPostProcessorTest : BaseGdProcessTest
    {
        ...
        public void Should_Search_SpecificUserPost()
        {
            ...
            SpecificUsersPostsProcessor SomeoneFollowerPostProcessor = new SpecificUsersPostsProcessor(_gdJobProcess,

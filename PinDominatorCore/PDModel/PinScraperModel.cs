...
namespace PinDominatorCore.PDModel
{
    public class PinScraperModel : ModuleSetting
    {
        ...
        public bool IsDownLoadAfterScrap
        {
            get => _isDownLoadAfterScrap;
            set
            {
                if (_isDownLoadAfterScrap == value)
                    return;
                SetProperty(ref _isDownLoadAfterScrap, value);
            }
        }

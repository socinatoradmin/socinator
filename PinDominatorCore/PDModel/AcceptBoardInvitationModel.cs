...
{
    public class AcceptBoardInvitationModel : ModuleSetting
    {
        private bool _isAcceptAllInvitations;

        private bool _isDeclineAllInvitations;
        ...
        [ProtoMember(1)]
        public bool IsAcceptAllInvitations
        {
            get => _isAcceptAllInvitations;
            set
            {
                if (_isAcceptAllInvitations == value)
                    return;
                SetProperty(ref _isAcceptAllInvitations, value);
            }
        }

        [ProtoMember(1)]
        public bool IsDeclineAllInvitations
        {
            get => _isDeclineAllInvitations;
            set
            {
                if (_isDeclineAllInvitations == value)
                    return;
                SetProperty(ref _isDeclineAllInvitations, value);
            }
        }
    }
}
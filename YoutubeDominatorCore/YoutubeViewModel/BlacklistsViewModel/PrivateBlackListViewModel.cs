...
namespace YoutubeDominatorCore.YoutubeViewModel.BlacklistsViewModel
{
    public class PrivateBlackListViewModel : BlackListViewModel, IPrivateBlickListViewModel
    {
        ...
        public override void AddToDB(List<string> lstuser)
        {
            ...
            _dbAccountService.AddMultiple(_blackListUser);
        ...
        public override void Search(object sender)
        {
            ...
            ThreadFactory.Instance.Start(() =>
            {
                ...
                var listBlacklistData = _dbAccountService.GetPrivateBlacklist().ToList();

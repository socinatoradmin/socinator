...
{
    public class DislikeBase : ModuleSettingsUserControl<DislikeViewModel, DislikeModel>
    {
    ...
    public partial class Dislike
    {
        ...
        public Dislike()
        {
            ...
            (
                header: HeaderGrid,
                footer: DislikeFooter,
                queryControl: DislikeSearchControl,
                MainGrid: MainGrid,
                activityType: ActivityType.Dislike,
                moduleName: YdMainModule.Unlike.ToString()
            );
        ...
        private static Dislike CurrentDislike { get; set; }

        public SelectChannel SelectChannel { get; set; }

        public static Dislike GetSingeltonObjectDislike()
        {
            return CurrentDislike ?? (CurrentDislike = new Dislike());
        }

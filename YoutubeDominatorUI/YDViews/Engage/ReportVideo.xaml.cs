...
{
    public class ReportVideoBase : ModuleSettingsUserControl<ReportVideoViewModel, ReportVideoModel>
    {
    ...
    public partial class ReportVideo
    {
        ...
        public ReportVideo()
        {
            ...
            (
                header: HeaderGrid,
                footer: ReportVideoFooter,
                queryControl: ReportVideoSearchControl,
                MainGrid: MainGrid,
                activityType: ActivityType.ReportVideo,
                moduleName: YdMainModule.ReportVideo.ToString()
            );
        ...
        private static ReportVideo CurrentReportVideo { get; set; }

        public SelectChannel SelectChannel { get; set; }

        public static ReportVideo GetSingeltonObjectReportVideo()
        {
            return CurrentReportVideo ?? (CurrentReportVideo = new ReportVideo());
        }

...
namespace YoutubeDominatorUI.YDViews.Scraper
{
    ...
    public partial class PostScraper
    {
        ...
        private PostScraperViewModel _objPostScraperViewModel;
        ...
        public PostScraper()
        {
            ...
            (
                ...
                moduleName: YdMainModule.PostScraper.ToString()
            );
        ...
        public PostScraperViewModel ObjPostScraperViewModel
        {
            get => _objPostScraperViewModel;
            set
            {
                _objPostScraperViewModel = value;
                OnPropertyChanged(nameof(ObjPostScraperViewModel));
            }
        }

...
namespace YoutubeDominatorUI.YDViews.GrowSubscribers
{
    ...
    public partial class Subscribe
    {
        ...
        private SubscribeViewModel _objSubscribeViewModel;
        ...
        public Subscribe()
        {
            ...
            (
                ...
                moduleName: YdMainModule.Subscribe.ToString()
            );
        ...
        public SubscribeViewModel ObjSubscribeViewModel
        {
            get => _objSubscribeViewModel;
            set
            {
                _objSubscribeViewModel = value;
                OnPropertyChanged(nameof(ObjSubscribeViewModel));
            }
        }

        public static Subscribe GetSingeltonObjectSubscribe()
        {

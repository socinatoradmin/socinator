...
namespace YoutubeDominatorUI.YDViews.WatchVideo
{
    public class ViewIncreaserBase : ModuleSettingsUserControl<ViewIncreaserViewModel, ViewIncreaserModel>
    {
    ...
    public partial class ViewIncreaser
    {
        private bool _enteredHere;

        private ViewIncreaserViewModel _objViewIncreaserViewModel;
        private Window _window;

        public ViewIncreaser()
        {
            InitializeComponent();
            ...
            (
                header: HeaderGrid,
                footer: ViewIncreaserFooter,
                queryControl: ViewIncreaserSearchControl,
                MainGrid: MainGrid,
                activityType: ActivityType.ViewIncreaser,
                moduleName: YdMainModule.ViewIncreaser.ToString() //"WatchVideoViewIncreaser"
            );
        ...
        private static ViewIncreaser CurrentViewIncreaser { get; set; }

        public SelectChannel SelectChannel { get; set; }

        public ViewIncreaserViewModel ObjViewIncreaserViewModel
        {
            get => _objViewIncreaserViewModel;
            set
            {
                _objViewIncreaserViewModel = value;
                OnPropertyChanged(nameof(ObjViewIncreaserViewModel));
            }
        }

        public static ViewIncreaser GetSingeltonObjectViewIncreaser()
        {
            return CurrentViewIncreaser ?? (CurrentViewIncreaser = new ViewIncreaser());
        }

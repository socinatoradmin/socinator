...
{
    public class CommentScraperViewCampaign : IYdViewCampaign
    {
        public void ManageCampaign(TemplateModel templateDetails, CampaignDetails campaignDetails,
            bool isEditCampaignName,
            Visibility cancelEditVisibility, string campaignButtonContent, string templateId)
        {
            var moduleUIObject = CommentScraper.GetSingeltonObjectCommentScraper();
            ...
            moduleUIObject.ObjViewModel.CommentScraperModel =
            ...
            moduleUIObject.CommentScraperFooter.list_SelectedAccounts = selectedAccounts;

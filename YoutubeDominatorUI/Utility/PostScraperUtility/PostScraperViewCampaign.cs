...
{
    public class PostScraperViewCampaign : IYdViewCampaign
    {
        public void ManageCampaign(TemplateModel templateDetails, CampaignDetails campaignDetails,
            bool isEditCampaignName,
            Visibility cancelEditVisibility, string campaignButtonContent, string templateId)
        {
            var moduleUIObject = PostScraper.GetSingeltonObjectPostScraper();
            ...
            moduleUIObject.ObjViewModel.PostScraperModel =
            ...
            moduleUIObject.PostScraperFooter.list_SelectedAccounts = selectedAccounts;

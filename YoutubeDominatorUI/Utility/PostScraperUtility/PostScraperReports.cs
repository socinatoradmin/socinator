...
{
    public class PostScraperReports : IYdReportFactory
    {
            ...
            List<KeyValuePair<string, string>> lstQueryDetails, CampaignDetails campaignDetails)
        {
            ...
            #region get data from InteractedUsers table and add to PostScraperReportModel
        ...
        public IList GetsAccountReport(IDbAccountService dataBase)
        {
            ...
            IList reportDetails = dataBase.Get<InteractedPosts>()
                .Where(x => x.ActivityType == ActivityType.PostScraper.ToString()).ToList();

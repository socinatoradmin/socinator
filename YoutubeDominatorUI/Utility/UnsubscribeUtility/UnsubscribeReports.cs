...
{
    public class UnsubscribeReports : IYdReportFactory
    {
            ...
            List<KeyValuePair<string, string>> lstQueryDetails, CampaignDetails campaignDetails)
        {
            ...
            #region get data from InteractedUsers table and add to UnsubscribeReportModel
        ...
        public IList GetsAccountReport(IDbAccountService dataBase)
        {
            ...
            IList reportDetails = dataBase
                .Get<InteractedChannels>()
                .Where(x => x.ActivityType.ToLower() == ActivityType.UnSubscribe.ToString().ToLower()).ToList();
        ...
        public void ExportReports(ReportType reportType, string fileName)
        {
            ...
            if (reportType == ReportType.Account)
                ...
                {
                    csvData.Add(utilities.CreateCsvDataForChannel(report));
                });
            ...
            Header = utilities.HeaderStringForChannelReport();

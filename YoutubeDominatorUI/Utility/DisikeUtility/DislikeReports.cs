...
{
    public class DislikeReports : IYdReportFactory
    {
        ...
        {
            return JsonConvert.DeserializeObject<DislikeModel>(activitySettings).SavedQueries;
        }
            ...
            List<KeyValuePair<string, string>> lstQueryDetails, CampaignDetails campaignDetails)
        {
            ...
            #region get data from InteractedUsers table and add to DislikeReportModel
        ...
        public IList GetsAccountReport(IDbAccountService dataBase)
        {
            ...
            IList reportDetails = dataBase.Get<InteractedPosts>()
                .Where(x => x.ActivityType == ActivityType.Dislike.ToString()).ToList();

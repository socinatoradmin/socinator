...
{
    public class LikeCommentViewCampaign : IYdViewCampaign
    {
        public void ManageCampaign(TemplateModel templateDetails, CampaignDetails campaignDetails,
            bool isEditCampaignName,
            Visibility cancelEditVisibility, string campaignButtonContent, string templateId)
        {
            var moduleUIObject = LikeComment.GetSingeltonObjectLikeComment();
            ...
            moduleUIObject.ObjViewModel.LikeCommentModel =
                JsonConvert.DeserializeObject<LikeCommentModel>(templateDetails.ActivitySettings);
            ...
            moduleUIObject.LikeCommentFooter.list_SelectedAccounts = selectedAccounts;

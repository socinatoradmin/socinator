...
{
    public class ViewIncreaserViewCampaign : IYdViewCampaign
    {
        public void ManageCampaign(TemplateModel templateDetails, CampaignDetails campaignDetails,
            bool isEditCampaignName,
            Visibility cancelEditVisibility, string campaignButtonContent, string templateId)
        {
            var moduleUIObject = ViewIncreaser.GetSingeltonObjectViewIncreaser();
            ...
            moduleUIObject.ObjViewModel.ViewIncreaserModel =
                JsonConvert.DeserializeObject<ViewIncreaserModel>(templateDetails.ActivitySettings);
            ...
            moduleUIObject.ViewIncreaserFooter.list_SelectedAccounts = selectedAccounts;

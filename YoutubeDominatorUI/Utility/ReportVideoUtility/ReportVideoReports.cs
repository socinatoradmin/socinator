...
{
    public class ReportVideoReports : IYdReportFactory
    {
        ...
        {
            return JsonConvert.DeserializeObject<ReportVideoModel>(activitySettings).SavedQueries;
        }
            ...
            List<KeyValuePair<string, string>> lstQueryDetails, CampaignDetails campaignDetails)
        {
            ...
            #region get data from InteractedUsers table and add to ReportVideoReportModel
                ...
                report =>
                {
                    if (!string.IsNullOrWhiteSpace(report.ChannelId))
                    {
                        ...
                        InteractedPostsModel.Add(new InteractedPostsReport
                        {
                            ...
                            SelectedOptionToVideoReport = report.SelectedOptionToVideoReport,
                            SelectedTimeStampToVideoReport = report.SelectedTimeStampToVideoReport
                        });
                    }
                });
            ...
            reportModel.GridViewColumn =
                new ObservableCollection<GridViewColumnDescriptor>
                {
                    ...
                    new GridViewColumnDescriptor
                    {
                        ColumnHeaderText = "Selected Report Option", ColumnBindingText = "SelectedOptionToVideoReport"
                    },
                    new GridViewColumnDescriptor
                        {ColumnHeaderText = "Additional details", ColumnBindingText = "MyCommentedText"},
                    new GridViewColumnDescriptor
                        {ColumnHeaderText = "Selected Timestamp", ColumnBindingText = "SelectedTimeStampToVideoReport"},
                    new GridViewColumnDescriptor
                        {ColumnHeaderText = "Reaction(ReportVideo) On Post", ColumnBindingText = "Reaction"},
        ...
        public IList GetsAccountReport(IDbAccountService dataBase)
        {
            ...
            IList reportDetails = dataBase.Get<InteractedPosts>()
                .Where(x => x.ActivityType == ActivityType.ReportVideo.ToString()).ToList();
            ...
            foreach (InteractedPosts item in reportDetails)
            {
                ...
                AccountsInteractedPosts.Add(
                    new InteractedPostsReport
                    {
                        ...
                        SelectedOptionToVideoReport = item.SelectedOptionToVideoReport,
                        SelectedTimeStampToVideoReport = item.SelectedTimeStampToVideoReport,
        ...
        public void ExportReports(ReportType reportType, string fileName)
        {
            ...
            if (reportType == ReportType.Account)
                ...
                {
                    csvData.Add(utilities.CreateCsvDataForPost(report, addReportedToVideoDetails: true));
                });
            ...
            Header = utilities.HeaderStringForPostReport(addReportedToVideoDetails: true);

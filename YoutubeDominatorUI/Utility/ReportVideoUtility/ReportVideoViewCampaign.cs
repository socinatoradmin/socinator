...
{
    public class ReportVideoViewCampaign : IYdViewCampaign
    {
        public void ManageCampaign(TemplateModel templateDetails, CampaignDetails campaignDetails,
            bool isEditCampaignName,
            Visibility cancelEditVisibility, string campaignButtonContent, string templateId)
        {
            var moduleUIObject = ReportVideo.GetSingeltonObjectReportVideo();
            ...
            moduleUIObject.ObjViewModel.ReportVideoModel =
                JsonConvert.DeserializeObject<ReportVideoModel>(templateDetails.ActivitySettings);
            ...
            moduleUIObject.ReportVideoFooter.list_SelectedAccounts = selectedAccounts;

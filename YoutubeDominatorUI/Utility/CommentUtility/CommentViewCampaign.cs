...
{
    public class CommentViewCampaign : IYdViewCampaign
    {
        public void ManageCampaign(TemplateModel templateDetails, CampaignDetails campaignDetails,
            bool isEditCampaignName,
            Visibility cancelEditVisibility, string campaignButtonContent, string templateId)
        {
            var moduleUIObject = Comment.GetSingeltonObjectComment();
            ...
            moduleUIObject.ObjViewModel.CommentModel =
            ...
            moduleUIObject.CommentFooter.list_SelectedAccounts = selectedAccounts;

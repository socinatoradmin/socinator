...
{
    public class ChannelScraperReports : IYdReportFactory
    {
            ...
            List<KeyValuePair<string, string>> lstQueryDetails, CampaignDetails campaignDetails)
        {
            ...
            #region get data from InteractedUsers table and add to ChannelScraperReportModel
        ...
        public IList GetsAccountReport(IDbAccountService dataBase)
        {
            ...
            IList reportDetails = dataBase
                ...
                .Where(x => x.ActivityType == ActivityType.ChannelScraper.ToString()).ToList();

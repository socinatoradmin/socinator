...
namespace TumblrDominatorUI.TabManager
{
    ...
    {
        public AccountTab(AccessorStrategies strategy)
        {
            Strategies = strategy;
            InitializeComponent();
            var items = new List<TabItemTemplates>
            {
                new TabItemTemplates
                {
                    ...
                    Content = new Lazy<UserControl>(() =>
                        AccountManager.GetSingletonAccountManager("AccountManager", null, SocialNetworks.Tumblr))
                },
                new TabItemTemplates
                {
        ...
        public AccessorStrategies Strategies { get; }

...
{
    public class GroupInviterBaseFactory : ILdBaseFactory
    {
        public ILdUtilityFactory LdUtilityFactory()
        {
            ...
            var builder = new LdBaseFactoryBuilder(utilityFactory)
                ...
                .AddReportFactory(new GroupInviterReport())
    ...
    public class GroupInviterReport : ILdReportFactory
    {
                ...
                InteractedGroupReportModel.ToList().ForEach(ReportItem =>
                {
                    try
                    {
                        CsvData.Add(ReportItem.AccountEmail + "," + ReportItem.QueryType + "," + ReportItem.QueryValue +
                                    ...
                                    ReportItem.GroupName + "," + ReportItem.GroupUrl + "," + ReportItem.TotalMembers +
    ...
    public class GroupInviterViewCampaign : ILdViewCampaign
    {
            ...
            bool IsEditCampaignName, Visibility CancelEditVisibility, string CampaignButtonContent, string TemplateID)
        {
            try
            {
                var objGroupJoiner = GroupInviter.GetSingeltonObjectGroupInviter();
                ...
                objGroupJoiner.GroupInviterFooter.list_SelectedAccounts = campaignDetails.SelectedAccountList;

                objGroupJoiner.ObjViewModel.GroupInviterModel =
                    templateDetails.ActivitySettings.GetActivityModel<GroupInviterModel>(objGroupJoiner.ObjViewModel
                        .Model);

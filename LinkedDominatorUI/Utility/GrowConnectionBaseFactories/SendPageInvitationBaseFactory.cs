...
{
    public class SendPageInvitationBaseFactory : ILdBaseFactory
    {
        public ILdUtilityFactory LdUtilityFactory()
        {
            ...
            var builder = new LdBaseFactoryBuilder(utilityFactory)
                .AddModuleName(ActivityType.SendPageInvitations)
                .AddReportFactory(new SendPageInvitationReport(ActivityType.SendPageInvitations))
                .AddViewCampaignFactory(new SendPageInvitationViewCampaign());

            return builder.LdUtilityFactory;
        }
    }
    public class SendEventInvitationBaseFactory : ILdBaseFactory
    {
        public ILdUtilityFactory LdUtilityFactory()
        {
            var utilityFactory = new LdUtilityFactory();
            ...
            var builder = new LdBaseFactoryBuilder(utilityFactory)
                ...
                .AddReportFactory(new SendPageInvitationReport(ActivityType.EventInviter))
                .AddViewCampaignFactory(new SendEventInvitationViewCampaign());

            return builder.LdUtilityFactory;
        }
    }
    public class SendEventInvitationViewCampaign: ILdViewCampaign
    {
            ...
            bool IsEditCampaignName, Visibility CancelEditVisibility, string CampaignButtonContent, string TemplateID)
        {
            try
            {
                var objSendPageInvitation = EventInviter.GetSingletonSendPageInvitation();
                objSendPageInvitation.IsEditCampaignName = IsEditCampaignName;
                objSendPageInvitation.CancelEditVisibility = CancelEditVisibility;
                objSendPageInvitation.TemplateId = TemplateID;
                objSendPageInvitation.CampaignName = CampaignButtonContent == ConstantVariable.UpdateCampaign()
                    ? campaignDetails.CampaignName
                    : objSendPageInvitation.CampaignName;
                objSendPageInvitation.CampaignButtonContent = CampaignButtonContent;
                objSendPageInvitation.SelectedAccountCount =
                    campaignDetails.SelectedAccountList.Count + $" {"LangKeyAccountSelected".FromResourceDictionary()}";
                objSendPageInvitation.SendEventInvitationFooter.list_SelectedAccounts =
                    campaignDetails.SelectedAccountList;
                objSendPageInvitation.ObjViewModel.InviteMemberToFollowPageModel =
                    templateDetails.ActivitySettings.GetActivityModel<InviteMemberToFollowPageModel>(
                        objSendPageInvitation.ObjViewModel.Model);
                objSendPageInvitation.MainGrid.DataContext = objSendPageInvitation.ObjViewModel;

                TabSwitcher.ChangeTabIndex(1, 9);
            }
            catch (Exception ex)
            {
                ex.DebugLog();
    ...
    public class SendPageInvitationReport : ILdReportFactory
    {
        ...
        public SendPageInvitationReport(ActivityType activitytype)
        {
        ...
        {
            return JsonConvert.DeserializeObject<InviteMemberToFollowPageModel>(activitySettings).SavedQueries;
        }
    ...
    public class SendPageInvitationViewCampaign : ILdViewCampaign
    {
        public void ManageCampaign(TemplateModel templateDetails, CampaignDetails campaignDetails,
            bool IsEditCampaignName, Visibility CancelEditVisibility, string CampaignButtonContent, string TemplateID)
        {
            try
            {
                var objSendPageInvitation = SendPageInvitation.GetSingletonSendPageInvitation();
                objSendPageInvitation.IsEditCampaignName = IsEditCampaignName;
                objSendPageInvitation.CancelEditVisibility = CancelEditVisibility;
                objSendPageInvitation.TemplateId = TemplateID;
                ...
                objSendPageInvitation.SelectedAccountCount =
                    campaignDetails.SelectedAccountList.Count + $" {"LangKeyAccountSelected".FromResourceDictionary()}";
                objSendPageInvitation.SendPageInvitationFooter.list_SelectedAccounts =
                    campaignDetails.SelectedAccountList;
                objSendPageInvitation.ObjViewModel.InviteMemberToFollowPageModel =
                    templateDetails.ActivitySettings.GetActivityModel<InviteMemberToFollowPageModel>(
                        objSendPageInvitation.ObjViewModel.Model);
                ...
                TabSwitcher.ChangeTabIndex(1, 6);
            }
            catch (Exception ex)
            {
                ex.DebugLog();

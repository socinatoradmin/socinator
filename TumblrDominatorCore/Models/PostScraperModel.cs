...
{
    public interface IPostScraperModel
    {
        RangeUtilities CommentToBeLikeAfterEachLikedPost { get; set; }
    }

    [ProtoContract]
    public class PostScraperModel : ModuleSetting, IPostScraperModel, IGeneralSettings
    {
        ...
        [ProtoMember(2)] public RangeUtilities CommentToBeLikeAfterEachLikedPost { get; set; } = new RangeUtilities();

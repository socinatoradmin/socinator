...
{
    public class MessageToPlacesReport : IFdReportFactory
    {
        ...
        private readonly string _activityType = ActivityType.MessageToPlaces.ToString();
                ...
                try
                {
                    AccountsInteractedPages.Add(
                        new PageReportAccountModel
                        {
                            ...
                            QueryType = report.QueryType,
                            QueryValue = report.QueryValue,
                            ActivityType = ActivityType.MessageToPlaces.ToString(),
                            PageName = report.PageName,
                            PageUrl = report.PageUrl,

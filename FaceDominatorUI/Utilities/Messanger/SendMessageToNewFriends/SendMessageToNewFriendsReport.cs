...
{
    public class SendMessageToNewFriendsReport : IFdReportFactory
    {
        ...
        private readonly string _activityType = ActivityType.SendMessageToNewFriends.ToString();
            ...
            List<KeyValuePair<string, string>> queryDetails, CampaignDetails campaignDetails)
        {
            ...
            reportModel.GridViewColumn =
                new ObservableCollection<GridViewColumnDescriptor>
                {
                    ...
                    new GridViewColumnDescriptor {ColumnHeaderText = "Text Message", ColumnBindingText = "Message"},
                    new GridViewColumnDescriptor
                    {

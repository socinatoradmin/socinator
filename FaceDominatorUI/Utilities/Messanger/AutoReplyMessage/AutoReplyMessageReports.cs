...
{
    public class AutoReplyMessageReports : IFdReportFactory
    {
        ...
        private readonly string _activityType = ActivityType.AutoReplyToNewMessage.ToString();
        public string Header { get; set; } = string.Empty;


        public ObservableCollection<QueryInfo> GetSavedQuery(ActivityType subModuleName, string activitySettings)
        {
            return JsonConvert.DeserializeObject<AutoReplyMessageModel>(activitySettings).SavedQueries;
        }
            ...
            List<KeyValuePair<string, string>> queryDetails, CampaignDetails campaignDetails)
        {
            ...
            reportModel.GridViewColumn =
                new ObservableCollection<GridViewColumnDescriptor>
                {
                    ...
                    new GridViewColumnDescriptor
                    {
                        ColumnHeaderText = "LangKeyMediaPath".FromResourceDictionary(),
        ...
        public void ExportReports(ActivityType activityType, string fileName, ReportType reportType)
        {
            ...
            {
                //Header = "AccountEmail,QueryType,QueryValue,User Profile Url,Message Sent To,Message Text,Media Path,Date";
            ...
            {
                //Header = "QueryType,QueryValue,User Profile Url,Message Sent To,Message Text,Media Path,Date";

...
{
    public class PostCommentorReports : IFdReportFactory
    {
        public static List<string> DataAccount = new List<string>();

        public static List<string> DataCampaign = new List<string>();

        private readonly string _activityType = ActivityType.PostCommentor.ToString();
            ...
            List<KeyValuePair<string, string>> queryDetails, CampaignDetails campaignDetails)
        {
                    ...
                    try
                    {
                                ...
                                x.PostId == post.Id && x.ReactedAsPageUrl == post.LikePostAsPageId) == null)
                        {
                            InteractedPostModel.Add(new PostReportModel
                            {
                                ...
                                CommentText = report.Comment?.Replace(",", string.Empty)?.Replace("\r\n", " "),
            ...
            reportModel.GridViewColumn =
                new ObservableCollection<GridViewColumnDescriptor>
                {
                    ...
                    new GridViewColumnDescriptor
                    {
                        ColumnHeaderText = "LangKeyIsCommentedAsPage".FromResourceDictionary(),
                    ...
                    new GridViewColumnDescriptor
                    {
                        ColumnHeaderText = "LangKeyUserMentions".FromResourceDictionary(),
                        ColumnBindingText = "Mentions"
                    },
                    ...
                    new GridViewColumnDescriptor
                        {ColumnHeaderText = "LangKeyOwnerId".FromResourceDictionary(), ColumnBindingText = "OwnerId"},
                    new GridViewColumnDescriptor
                    {
                            ...
                            x.PostId == post.Id && x.ReactedAsPageUrl == post.LikePostAsPageId) == null)
                    {
                                ...
                                x.Contains(post.LikePostAsPageId)) == null)
                        {
                            ...
                            DataAccount.Add(report.QueryType + ","
                                                             ...
                                                             + report.PostId + ","
                                                             + $"{FdConstants.FbHomeUrl}{report.PostId}" + ","
                                                             + $"\"{report.Comment.Replace(",", string.Empty).Replace("\r\n", " ").Replace("\n", " ")}\"" +
                                                             ","
                                                             + $"{isLikedCommentedAsPage}" + ","
                                                             + likeAsPageUrl + ","
                                                             + report.Mentions + ","
        ...
        public void ExportReports(ActivityType activityType, string fileName, ReportType reportType)
        {
            ...
            {
                //Header = "AccountEmail,QueryType,QueryValue,Post Id,Post Url,Comment Text,Is Commented As Page, Commented as Page Url,User Mentions,Like Count,Comment Count,Share  Count,Post Description,SubDescription,Posted DateTime,Post Title, Posted By ,Owner Id, MediaType , Media Url ,Other MediaUrl,Navigation Url , Date";
            ...
            {
                //Header = "QueryType,QueryValue,Post Id,Post Url,Comment Text,Is Commented As Page, Commented as Page Url,User Mentions,Like Count,Comment Count,Share  Count,Post Description,SubDescription,Posted DateTime,Post Title, Posted By ,Owner Id, MediaType , Media Url ,Other MediaUrl,Navigation Url , Date";
        ...
        public string PostsReportHeader(bool addAccount = true)
        {
            ...
            listResource.Add("LangKeyIsCommentedAsPage");
            listResource.Add("LangeKeyCommentedAsPageUrl");

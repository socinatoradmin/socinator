...
{
    public class CommentLikerReports : IFdReportFactory
    {
        ...
        private readonly string _activityType = ActivityType.LikeComment.ToString();
        public string Header { get; set; } = string.Empty;

        public ObservableCollection<QueryInfo> GetSavedQuery(ActivityType subModuleName, string activitySettings)
        {
            return JsonConvert.DeserializeObject<CommentLikerModule>(activitySettings).SavedQueries;
        }
            ...
            List<KeyValuePair<string, string>> queryDetails, CampaignDetails campaignDetails)
        {
            ...
            //Header = "AccountEmail,QueryType,QueryValue,Comment Url,Comment Text,Commenter Id,Post Id,Comment DateTime,Comment Liker Count,React as Page ID, Date";
            ...
            dataBase.GetAllInteractedData<InteractedComments>().ForEach(
                report =>
                {
                    //var queryDetail = queryDetails.FirstOrDefault(x => x.Key == report.QueryType);

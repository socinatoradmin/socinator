...
{
    public class GroupUnJoinerReports : IFdReportFactory
    {
        ...
        private readonly string _activityType = ActivityType.GroupUnJoiner.ToString();
        ...
        public void ExportReports(ActivityType activityType, string fileName, ReportType reportType)
        {
            ...
            if (csvData.Count == 0)
            {
                Dialog.ShowDialog(Application.Current.MainWindow, "LangKeyWarning",
                    "LangKeyReportIsNotAvailable".FromResourceDictionary());
                return;
            }

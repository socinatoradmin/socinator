...
{
    public class CommnetrRepliesScraperViewCampaign : IFdViewCampaign
    {
            ...
            Visibility cancelEditVisibility, string campaignButtonContent, string templateId)
        {
            var singeltonObjectCommentScraper =
                FDViews.FbScraper.CommnetrRepliesScraper.GetSingeltonObjectCommnetrRepliesScraper();
            ...
            singeltonObjectCommentScraper.CommnetrRepliesScraperFooter.list_SelectedAccounts =
                campaignDetails.SelectedAccountList;

            singeltonObjectCommentScraper.ObjViewModel.CommentRepliesScraperModel
                = templateDetails.ActivitySettings.GetActivityModel<CommentRepliesScraperModel>(
            ...
            TabSwitcher.ChangeTabIndex(6, 4);
        }
    }
}
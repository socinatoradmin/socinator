...
{
    public class DownloadMediaReports : IFdReportFactory
    {
        public static List<string> DataAccount = new List<string>();

        public static List<string> DataCampaign = new List<string>();

        private readonly string _activityType = ActivityType.DownloadScraper.ToString();
            ...
            List<KeyValuePair<string, string>> queryDetails, CampaignDetails campaignDetails)
        {
            ...
            dataBase.GetAllInteractedData<InteractedPosts>().ForEach(
                report =>
                {
                    ...
                    {
                        var post =
                            JsonConvert.DeserializeObject<FacebookPostDetails>(report.PostDescription);

                        post.PostedBy = !string.IsNullOrEmpty(post.PostedBy) ? post.PostedBy : post.OwnerId;
                        ...
                        if (InteractedPostModel.FirstOrDefault(x => x.PostId == post.Id) == null)
                        {
                            InteractedPostModel.Add(new PostReportModel
                            {
                                ...
                                DownLoadFolderPath = post.DownLoadPath,
            ...
            reportModel.GridViewColumn =
                new ObservableCollection<GridViewColumnDescriptor>
                {
                    ...
                    new GridViewColumnDescriptor
                    {
                        ColumnHeaderText = "LangKeyFolderPath".FromResourceDictionary(),
                        ColumnBindingText = "DownLoadFolderPath"
                    },
                    new GridViewColumnDescriptor
                ...
                if (InteractedPostModel.FirstOrDefault(x => x.PostId == post.Id) == null)
                {
                    AccountsInteractedPostModel.Add(
                        new PostReportAccountModel
                        {
                            ...
                            QueryType = report.QueryType,
                            QueryValue = report.QueryValue,
                            ActivityType = ActivityType.DownloadScraper.ToString(),
                            PostUrl = FdConstants.FbHomeUrl + report.PostId,
                            DownloadFolderPath = post.DownLoadPath,
                            Likes = post.LikersCount,
                            Comments = post.CommentorCount,
        ...
        public void ExportReports(ActivityType activityType, string fileName, ReportType reportType)
        {
            ...
            {
                //Header = "AccountEmail,QueryType,QueryValue,Post Id,Post Url,Download Path,Like Count,Comment Count,Share  Count,Post Description,SubDescription,Posted DateTime,Post Title, Posted By , MediaType , Media Url ,Other MediaUrl,Navigation Url , Date";
            ...
            {
                //Header = "QueryType,QueryValue,Post Id,Post Url,Download Path,Like Count,Comment Count,Share  Count,Post Description,SubDescription,Posted DateTime,Post Title, Posted By , MediaType , Media Url ,Other MediaUrl,Navigation Url , Date";
        ...
        public string PostsReportHeader(bool addAccount = true)
        {
            ...
            listResource.Add("LangKeyDownloadPath");

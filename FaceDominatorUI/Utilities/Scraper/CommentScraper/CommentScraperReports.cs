...
{
    public class CommentScraperReports : IFdReportFactory
    {
            ...
            List<KeyValuePair<string, string>> queryDetails, CampaignDetails campaignDetails)
        {
            ...
            Header =
                "AccountEmail,QueryType,QueryValue,Comment Url,Comment Text,Commenter Id,Post Id,Comment DateTime,Comment Liker Count,Date";

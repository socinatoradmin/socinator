...
{
    public class ProfileScraperReports : IFdReportFactory
    {
            ...
            dataBase.GetAllInteractedData<InteractedUsers>().ForEach(
                report =>
                {
                    ...
                    CampaignData.Add(report.AccountEmail + "," + report.QueryType + ","
                                     ...
                                     + (string.IsNullOrEmpty(objfacebokuser.Address)
                                         ? "NA"
                                         : objfacebokuser.Address?.Replace(",", " ")) + ","
                                     + (string.IsNullOrEmpty(objfacebokuser.NeighBorHood)
                                         ? "NA"
                                         : objfacebokuser.NeighBorHood?.Replace(",", " ")) + ","
                                     + (string.IsNullOrEmpty(objfacebokuser.AddressMapUrl)
                                         ? "NA"
                                         : objfacebokuser.AddressMapUrl?.Replace(",", " ")) + ","
                                     ...
                                     + (string.IsNullOrEmpty(objfacebokuser.Email)
                                         ? "NA"
                                         : objfacebokuser.Email?.Replace(",", " ")));
                });
        ...
        public void ExportReports(ActivityType activityType, string fileName, ReportType reportType)
        {
            ...
            {
                //Header = "AccountEmail,QueryType,QueryValue,User Profile Url,Username,Gender,Date,University,Workplace,Currntcity,Hometown,BirthDate,Contactno,Address,Neighborhood,AddressMapUrl,Profile Pic Url, Relationship, Email";
            ...
            {
                //Header = "QueryType,QueryValue,User Profile Url,Username,Gender,Date,University,Workplace,Currntcity,Hometown,BirthDate,Contactno,Address,Neighborhood,AddressMapUrl,Profile Pic Url, Relationship, Email";
        ...
        public string PostsReportHeader(bool addAccount = true)
        {
            ...
            listResource.Add("LangKeyNeighbourhood");
            listResource.Add("LangKeyAddressMapUrl");

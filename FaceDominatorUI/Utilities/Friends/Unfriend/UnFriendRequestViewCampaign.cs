...
{
    public class UnFriendRequestViewCampaign : IFdViewCampaign
    {
        public void ManageCampaign(TemplateModel templateDetails, CampaignDetails campaignDetails,
            bool isEditCampaignName,
            Visibility cancelEditVisibility, string campaignButtonContent, string templateId)
        {
            var singeltonObjectFriendRequest = FDViews.FbFriends.Unfriend.GetSingeltonObjectUnfriend();
            ...
            singeltonObjectFriendRequest.UnfriendFooter.list_SelectedAccounts = campaignDetails.SelectedAccountList;

            singeltonObjectFriendRequest.ObjViewModel.UnfriendModel
                = templateDetails.ActivitySettings.GetActivityModelNonQueryList<UnfriendModel>(

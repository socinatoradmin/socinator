...
{
    public class SendFriendRequestReports : IFdReportFactory
    {
        ...
        private readonly string _activityType = ActivityType.SendFriendRequest.ToString();
        public string Header { get; set; } = string.Empty;

        public ObservableCollection<QueryInfo> GetSavedQuery(ActivityType subModuleName, string activitySettings)
        {
            return JsonConvert.DeserializeObject<SendFriendRequestModel>(activitySettings).SavedQueries;
        }
            ...
            foreach (InteractedUsers report in reportDetails)
            {
                AccountsInteractedUsers.Add(
                    new SendFriendAccountModel
                    {
                        ...
                        ActivityType = ActivityType.SendFriendRequest.ToString(),
        ...
        public void ExportReports(ActivityType activityType, string fileName, ReportType reportType)
        {
            ...
            {
                //Header = "AccountEmail,QueryType,QueryValue,User Profile Url,Request Sent To,Date,Gender,University,Workplace,Currntcity,Hometown,BirthDate,Contactno,Profile Pic Url, Relationship";
            ...
            {
                //Header = "QueryType,QueryValue,User Profile Url,Request Sent To,Date,Gender,University,Workplace,Currntcity,Hometown,BirthDate,Contactno,Profile Pic Url, Relationship";
            ...
            List<KeyValuePair<string, string>> queryDetails, CampaignDetails campaignDetails)
        {
            ...
            dataBase.GetAllInteractedData<DominatorHouseCore.DatabaseHandler.FdTables.Campaigns.InteractedUsers>()
                .ForEach(
                    report =>
                    {
                        if (report.ActivityType == ActivityType.SendFriendRequest.ToString())
                        {
                            ...
                            {
                                var objfacebokuser =
                                    JsonConvert.DeserializeObject<FacebookUser>(report.DetailedUserInfo);

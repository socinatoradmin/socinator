...
{
    /// <summary>
    ///     Interaction logic for DownloadPhotosTab.xaml
    /// </summary>
    public partial class DownloadPhotosTab : UserControl
    {
        public DownloadPhotosTab()
        {
            InitializeComponent();
            var tabItems = new List<TabItemTemplates>
            {
                new TabItemTemplates
                {
                    Title = Application.Current.FindResource("LangKeyConfiguration") != null
                        ...
                        : "Configuration",
                    Content = new Lazy<UserControl>(DownloadPhotosConfiguration
                        .GetSingeltonObjectDownloadPhotosConfiguration)
                },
                new TabItemTemplates
                {
            ...
            DownloadPhotosTabControl.ItemsSource = tabItems;
        }
    }
}